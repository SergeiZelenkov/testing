export const cards = [
  ...
  {
    name: "mastercard",
    start: [2221, 2720, 5479, 5354, 5517],
    cardlength: [16],
  },
  { name: "americanexpress", start: [34, 37], cardlength: [15] },
  {
    name: "maestro",
    start: [5018, 5020, 5038, 5893, 6304, 6759, 6761, 6762, 6763],
    cardlength: [12, 13, 14, 15, 16, 17, 18, 19],
  },
  { name: "discover", start: [6011], cardlength: [16, 17, 18, 19] },
  {
    name: "jcb",
    start: [3528, 3589, 3536, 3536, 3534, 3538, 3530, 3532],
    cardlength: [16, 17, 18, 19],
  },
  {
    name: "mir",
    start: [2200, 2201, 2202, 2203, 2204],
    cardlength: [16, 17, 18, 19],
  },
];
